                ...
                <div className="container">
                    <div className="breadcrumb-inner">
                        <div className="section-title mb-0 text-center">
                            <h2 className="page-title">Career Awareness Details</h2>
                            <ul className="page-list">
                                <li><a href="index.html">Home</a></li>
                                <li>Career Awareness Details</li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="col-lg-8 order-lg-12">
                            <div className="event-detaila-inner">
                                <div className="thumb mb-4">
                                    <img src="assets/img/other/5.png" alt="img" />
                                </div>
...
export default CareerAwarenessDetails;
